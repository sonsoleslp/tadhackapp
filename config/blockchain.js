module.exports = {
  ...
  default: {
    enabled: true,
    rpcHost: "159.65.195.95", // HTTP-RPC server listening interface (default: "159.65.195.95")
    ...
    wsOrigins: "auto",  // Origins from which to accept websockets requests
                        // When set to "auto", Embark will automatically set the cors to the address of the webserver
    wsHost: "159.65.195.95", // WS-RPC server listening interface (default: "159.65.195.95")
  ...
  livenet: {
    networkType: "livenet",
    syncMode: "light",
    rpcCorsDomain: "http://159.65.195.95:8000",
    wsOrigins: "http://159.65.195.95:8000",
    account: {
